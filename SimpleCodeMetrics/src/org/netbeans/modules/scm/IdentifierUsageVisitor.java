...
class IdentifierUsageVisitor extends TreeScanner<Set<String>, Set<String>> {
        
        @Override
        public Set<String> visitIdentifier(IdentifierTree node, Set<String> in) {
            Set<String> superRes = super.visitIdentifier(node, in);
            if (superRes == null) {
                superRes = new HashSet<String>();
            }
            if (node != null) {
                superRes.add(node.getName().toString());
            }
            return superRes;
        }

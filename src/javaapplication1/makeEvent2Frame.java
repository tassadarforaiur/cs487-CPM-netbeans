 ...
 * @author manny
 */
public class makeEvent2Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        label1.setText("Choose a Banner Image (.jpg only)");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(fileChooser, javax.swing.GroupLayout.PREFERRED_SIZE, 357, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        makeEvent3Frame vME3F = new makeEvent3Frame(googleID,tempEvent);
        vME3F.setVisible(true);
        close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(makeEvent2Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new makeEvent2Frame().setVisible(true);
            }
        });
    }
